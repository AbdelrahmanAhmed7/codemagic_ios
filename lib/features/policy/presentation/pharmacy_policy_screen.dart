...
class PharmacyPolicyScreen extends StatefulWidget {
  const PharmacyPolicyScreen({super.key});

  @override
  State<PharmacyPolicyScreen> createState() => _PharmacyPolicyScreenState();
}

class _PharmacyPolicyScreenState extends State<PharmacyPolicyScreen> {
  ...
  Widget build(BuildContext context) {
    final policyDetails = PolicyMockData.getPharmacyPolicyDetails();
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            const PageHeader(title: 'Pharmacy Policy', backPath: '/policy'),
            Expanded(
